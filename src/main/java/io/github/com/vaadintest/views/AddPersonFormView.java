...
public class AddPersonFormView extends Composite<VerticalLayout> {
    ...
    private Person registerPerson(
        ...
        firstName.setValue(EMPTY_VALUE);
        lastName.setValue(EMPTY_VALUE);
        birthDate.setValue(null);
        phoneNumber.setValue(EMPTY_VALUE);
        email.setValue(EMPTY_VALUE);
        occupation.setValue(EMPTY_VALUE);
        return person;
    }

    public AddPersonFormView(PersonJpaRepository repository) {
        ...
        buttonPrimary.addClickListener(e -> {
            var person = registerPerson(textField, textField2, datePicker, textField3, emailField, textField4);
            Notification.show("Person with name " + person.getName() + " has been registered.");
        });
